...
export function InquiryDetails({ inquiry, onClose }: InquiryDetailsProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-lg md:max-w-xl h-full bg-white shadow-2xl flex flex-col z-10 border-l border-slate-200 animate-in slide-in-from-right duration-300 ease-out">
        {/* Header Container */}
        ...
        <div className="p-6 flex-1 overflow-y-auto space-y-6 text-sm text-slate-700">
          ...
          {/* Section 4: Operational System Context */}
          <div className="pt-2">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">
              System Telemetry
            </h3>
